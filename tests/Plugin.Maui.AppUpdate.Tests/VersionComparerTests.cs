...
public sealed class VersionComparerTests
{
    ...
    [Fact]
    public void IsNewerThan_requires_a_greater_candidate()
    {
        Assert.True(VersionComparer.IsNewerThan("2.0.0", "1.9.9"));
        Assert.False(VersionComparer.IsNewerThan("1.0.0", "1.0.0"));
        Assert.False(VersionComparer.IsNewerThan(null, "1.0.0"));
    }
