# Plugin.Maui.AppUpdate — AI Coding Agent Guide

## Project

Cross-platform in-app updates for .NET MAUI: Google Play In-App Updates, App Store version checks, mandatory/recommended prompts, and maintenance mode.
